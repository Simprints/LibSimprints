...
public class Constants {
    ...
    final public static int SIMPRINTS_SAFETYNET_DOWN = Activity.RESULT_FIRST_USER +22;
    final public static int SIMPRINTS_SAFETYNET_ERROR = Activity.RESULT_FIRST_USER + 23;
